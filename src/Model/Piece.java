...
public abstract class Piece {
	...
	/**
	 * Stub method that can be overridden 
	 * if a piece needs to perform an action after they move. 
	 * (Ex. The pawn must know when it has been moved 
	 * already to determine if it can move 2 spaces)
	 */
