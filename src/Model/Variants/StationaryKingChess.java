...
import Model.Pieces.StationaryKing;
...
public class StationaryKingChess extends Variant {
	public StationaryKingChess(List<Board> boards) {
		super(2);
	...
	private void initBoard(Board board) {
		...
		board.getTile(new Point(4, 0)).setPiece(new StationaryKing(team));
		...
		board.getTile(new Point(4, 7)).setPiece(new StationaryKing(team));
