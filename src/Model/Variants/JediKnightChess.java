...
import Model.Pieces.JediKnight;
...
public class JediKnightChess extends Variant {
	public JediKnightChess(List<Board> boards) {
		super(2);
	...
	private void initBoard(Board board) {
		...
		board.getTile(new Point(1, 0)).setPiece(new JediKnight(team));
		...
		board.getTile(new Point(6, 0)).setPiece(new JediKnight(team));
		...
		board.getTile(new Point(1, 7)).setPiece(new JediKnight(team));
		...
		board.getTile(new Point(6, 7)).setPiece(new JediKnight(team));
